...
OpenLayers.Layer.Bing = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    loadMetadata: function() {
        ...
        if (protocol === 'https:') {
          metadataParams.uriScheme = 'https';
        }
        var params = OpenLayers.Util.applyDefaults(metadataParams, this.metadataParams);
        var url = protocol + "//dev.virtualearth.net/REST/v1/Imagery/Metadata/" +
